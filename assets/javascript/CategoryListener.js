...
function card(name, subtitle, price, id, imgPath) {
    return `<<div class="col-xl-4 mb-3">
                            <div class="product-card mt-5">
                                <img src="../products/${imgPath}"
                                    alt="IndexKep" srcset="" class="img-fluid" id="asd">
                                <div class="line ms-md-5 me-md-5 mt-3 mb-3"></div>
                                <h5 class="p-title text-center">${name}</h5>
                                <p class="text-black-50 text-center mt-3">${subtitle}</p>
                                <p class="text-success ms-4 mt-2 mb-3" style="font-weight:  bold;">Ár: ${price} FT</p>
